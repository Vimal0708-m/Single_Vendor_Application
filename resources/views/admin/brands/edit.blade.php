...
@section('content')
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Edit Brand</h2>
    </div>
                    ...
                    @if ($brand->logo)
                        <div class="mb-3">
                            ...
                            <label class="mt-2 flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                <input type="checkbox" name="remove_logo" value="1" class="rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                                Remove current logo
                            </label>
                        </div>
                    @endif
